...
public class PersistentDataManager : MonoBehaviour
{
    ...
    {
        GameObject dataManagerGameObject = new("PersistentDataManager");
        DontDestroyOnLoad(dataManagerGameObject);
        instance = dataManagerGameObject.AddComponent<PersistentDataManager>();
        return instance;
    }

    protected HashSet<IDataPersister> m_DataPersisters = new();
    protected Dictionary<string, Data> m_Store = new();
