...
/// <summary>
/// The HealthDamager class represents an object that can deal damage to HealthController objects.
...
{
    [Serializable] public class DamageableEvent : UnityEvent<HealthDamager, HealthController> { }

    [Serializable] public class NonDamageableEvent : UnityEvent<HealthDamager> { }
    ...
    void FixedUpdate()
    {
        ...
        for (int i = 0; i < hitCount; i++)
        {
            ...
            HealthController damageable = m_LastHit.GetComponent<HealthController>();
