...
{
    static protected Dictionary<GameObject, BulletPool> s_PoolInstances = new();
    ...
    {
        if (!s_PoolInstances.TryGetValue(prefab, out BulletPool objPool))
        {
            GameObject obj = new(prefab.name + "_Pool");
